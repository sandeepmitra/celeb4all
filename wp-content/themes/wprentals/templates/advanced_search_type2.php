...
<div class="adv-search-2 <?php echo $google_map_lower_class.' '.$close_class.' '.$extended_class;?>" id="adv-search-1" data-postid="<?php echo $post_id; ?>"> 
    ...
    <form  method="get"  id="main_search" action="<?php print $adv_submit; ?>" >
        ...
        <div class="col-md-12 has_calendar calendar_icon">
            <input type="text" id="check_in"    class="form-control " name="check_in"  placeholder="<?php esc_html_e('Check In','wpestate');?>" value="" >       
        </div>
        
        <div class="col-md-12  has_calendar calendar_icon">
            <input type="text" id="check_out"   disabled class="form-control" name="check_out" placeholder="<?php esc_html_e('Check Out','wpestate');?>" value="">
        </div>
        
        <div class="col-md-12">
            <div class="dropdown form-control">
                <div data-toggle="dropdown" id="guest_no" class="filter_menu_trigger" data-value="all"> <?php esc_html_e('Guests','wpestate');?> <span class="caret caret_filter"></span> </div>           

...
if( $user_small_picture_id == '' ){
    ...
    $user_small_picture = $profile_img;
...
<?php if(is_user_logged_in()){ ?>
    ...
    <div class="user_menu user_loged" id="user_menu_u">
        ...
        <div class="menu_user_picture" style="background-image: url('<?php echo $profile_img; ?>');"></div>
...
?> 
    ...
    <div id="user_menu_open"> 
        ...
        <a href="<?php echo home_url() ?>/profile" title="my profile" class="menulogout"><i class="fa fa-user"></i><?php esc_html_e('My Profile','wpestate');?></a>  

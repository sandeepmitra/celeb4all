...
<div class="col-md-12">
    ...
    <div class="col-md-3">
        <p>
            <label  for="price_per_weekeend"> <?php esc_html_e('Price per weekend (Saturday and Sundays) in ','wpestate');print $wp_estate_currency_symbol.' '; esc_html_e('(only numbers)','wpestate'); ?>  </label>
    ...
    <div class="col-md-3 check_adjust">
        <p>
            ...
            <label style="float:left;" for="cleaning_fee"><?php esc_html_e('Cleaning Fee applies per night:','wpestate');?></label>
        </p> 
    </div>
    ...
    <div class="col-md-3 check_adjust">
        <p>
            ...
            <label style="float:left;" for="cleaning_fee"><?php esc_html_e('City Fee applies per night:','wpestate');?></label>
        </p> 
    </div>
    ...
    <div class="booking-calendar-wrapper-in-wrapper" id="custom_price_wrapper">
        <?php 
            $custom_price_array  =   get_post_meta($edit_id, 'custom_price'.$edit_id,true );
            $mega_details        =   get_post_meta($edit_id, 'mega_details'.$edit_id,true );

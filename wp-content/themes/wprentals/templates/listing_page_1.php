...
<div style="padding-left: 0; padding-right: 0;" class="container-fluid">
    <div class="row">
        ...
        <div class="owner-page-wrapper-inside row">
            ...
            <div class="col-md-2">
                <div class="owner-image-container" style="background-image: url('http://celeb4all.inforain.in/wp-content/uploads/2016/12/3.-Salman-khan.jpg');"></div>
            </div>    
            <div class="col-md-10">
                <h1 class="entry-title-agent">sumanta</h1>
                                    <div class="property_ratings_agent">
                         <i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i>                       <span class="owner_total_reviews">(0)</span>
                    </div>
                ...
                <div id="contact_me_long_owner" class=" owner_read_more" data-postid="237">Contact Owner</div>
    ...
    <div class=" 
        ...
        widget-area-sidebar listingsidebar2 listing_type_1" id="primary" >
            ...
            <div class="listing_main_image_price">
                ...
                <?php  wpestate_show_price($post->ID,$currency,$where_currency,0); echo ' '.esc_html__( 'per night','wpestate'); ?>

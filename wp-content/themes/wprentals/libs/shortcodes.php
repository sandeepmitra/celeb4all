             ...
             $return_string.='
                    ...
                    <div class="col-md-3 map_icon "> <!-- map_icon -->';
                        ...
                        if($show_adv_search_general=='no'){
                            ...
                            $return_string.='<input type="hidden" id="stype" name="stype" value="tax">';
                        }
...
function wpestate_register_form_function($attributes, $content = null) {
    ...
    $return_string.=' 
                ...
                <button id="wp-submit-register'.$type.'"  class="wpb_button  wpb_btn-info  wpb_btn-small wpestate_vc_button  vc_button">'.esc_html__( 'Create an account','wpestate').'</button>

...
function wpestate_theme_admin_adv_search(){
    ...
    /*
    print '<h1 class="wpestate-tabh1">'.esc_html__( 'Custom Fields for Advanced Search','wpestate').'</h1>'; 
    print'    <table class="form-table">
         ...
         <tr valign="top">
            <th scope="row"><label for="admin_submission"><strong>'.esc_html__( 'Place in advanced search form','wpestate').'</strong></label></th>          
            <td><strong>'.esc_html__( 'Search field','wpestate').'</strong></td>
            <td><strong>'.esc_html__( 'How it will compare','wpestate').'</strong></td>
            <td><strong>'.esc_html__( 'Label on Front end','wpestate').'</strong></td>
        </tr>'; 
    ...
    while( $i < 8 ){
       ...
       print '
       <tr valign="top">
            <th scope="row"><label for="admin_submission">'.esc_html__( 'Spot no ','wpestate').$i.'</label></th>
	...
	print'	</select>
        ...
        '.esc_html__( '*Labels will not apply for dropdowns fields','wpestate').'</br>
...
function wpestate_theme_admin_membershipsettings(){
    ...
    print '
        ...
        <tr valign="top">
            <th scope="row"><label for="book_down">'.esc_html__( 'Booking - the % of downpayment','wpestate').' </label></th>
            <td>
...
*/
    ...
    print '
        ...
        <tr valign="top">
          ...
          <tr valign="top">
            <th scope="row"></th>
            <td>'.esc_html__( 'The Google Maps JavaScript API v3 does not require an API key to function correctly. However, we strongly encourage you to get  an APIs Console key and post the code in Theme Options. You can get it from ','wpestate').'<a href="https://developers.google.com/maps/documentation/javascript/tutorial#api_key">'.esc_html__('here','wpestate').'</a>.</td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top">
            <th scope="row"><label for="copyright_message">'.esc_html__( 'Use Cache for Google maps ?(*cache will renew it self every 3h)','wpestate').'</label></th>
...
function wpestate_theme_admin_apperance(){
    ...
    print '<table class="form-table">     
        ...
        <tr valign="top">
            <th scope="row"><label for="headings_font_subset">'.esc_html__( 'Second Font subset','wpestate').'</label></th>
            <td>

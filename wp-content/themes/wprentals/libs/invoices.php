                           ...
                           foreach($details as $detail){
                               print'<div class="invoice_row invoice_content">
                                    ...
                                    if(trim($detail[0])==esc_html__( 'Extra Guests','wpestate')){ 
                                        print $booking_array['numberDays'].' '.esc_html__( 'days','wpestate').' x '.$booking_array['extra_guests'].' '.esc_html__('extra guests','wpestate').' x '.$guest_price.' '.esc_html__( 'per day','wpestate');
                                    }

...
if( !function_exists('wpestate_ajax_check_booking_valability_internal') ):
    function wpestate_ajax_check_booking_valability_internal(){
        ...
        $mega       =   get_post_meta($listing_id, 'mega_details'.$listing_id,true );
...
if( !function_exists('wpestate_create_pay_user_invoice_form') ):
    function wpestate_create_pay_user_invoice_form(){
        ...
        $invoice_price      =   intval( get_post_meta($invoice_id, 'item_price', true)) ;
            ...
            <div class="create_invoice_form">
                   ...
                   <div class="invoice_table">
                       <div class="invoice_data">
                        ...
                        print ' 
                            <div class="invoice_row invoice_total total_inv_span ">
...
if( !function_exists('wpestate_booking_insert_invoice') ): 
    function wpestate_booking_insert_invoice($billing_for,$type,$pack_id,$date,$user_id,$is_featured,$is_upgrade,$paypal_tax_id,$details,$price){
        ...
        $cleaning_fee = intval   ( get_post_meta($property_id, 'cleaning_fee', true) );
        update_post_meta($post_id, 'cleaning_fee', $cleaning_fee);
        
        $city_fee = intval   ( get_post_meta($property_id, 'city_fee', true) );
...
if( !function_exists('wpestate_mess_front_end') ):
    function wpestate_mess_front_end(){
        ...
        $message_user .= ' Sent for property '.get_the_title($property_id).', with the link: '.get_permalink($property_id).' ';
        $message_user .=    esc_html__( 'Selected dates: ','wpestate').$booking_from_date.esc_html__( ' to ','wpestate').$booking_to_date.", ".esc_html__( ' guests:','wpestate').$booking_guest_no.". Message Content: ".$message_from_user;

...
<div class="row is_dashboard">
    ...
    <div class=" dashboard-margin">
        ...
        <div class="row admin-list-wrapper inbox-wrapper">    
            ...
            <div class="arrow-wrapper-allinone_legend">
                <?php _e('The all in one calendar will not be displayed corectly on resolution lower than 1200px(lack of space). Please do not use this feature on mobile devices.','wpestate');?>
            </div>

...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class($is_top_bar_class); ?>> 
       ...
       <!-- <div id="mpcth_header_second_section">						<div class="mpcth-header-wrap">							<div id="mpcth_page_header_secondary_content" class="mpcth-header-order-n_s_m mpcth-header-position-top">							<div id="mpcth_secondary_menu">								<span class="mpcth-language"></span>								<span class="mpcth-currency"></span>							</div>								<ul id="mpcth_header_socials" class="mpcth-socials-list">								<li><a target="_blank" href="#" class="mpcth-social-facebook"><i class="fa fa-facebook"></i></a></li>								<li><a target="_blank" href="#" class="mpcth-social-google-plus"><i class="fa fa-google-plus"></i></a></li>								<li><a target="_blank" href="#" class="mpcth-social-linkedin"><i class="fa fa-linkedin"></i></a></li>								<li><a target="_blank" href="#" class="mpcth-social-twitter"><i class="fa fa-twitter"></i></a></li>								</ul>							</div>						</div>		</div>-->
        <div class="website-wrapper <?php echo $is_top_bar_class;?>"  id="all_wrapper">
            <div class="container main_wrapper <?php print $wide_class; print $is_dashboard_page; ?> ">
				...
				<!--<div id="mpcth_header_second_section">
						...
						<div id="mpcth_page_header_secondary_content" class="mpcth-header-order-n_s_m mpcth-header-position-top">
						<div id="mpcth_secondary_menu">
							<span class="mpcth-language"></span>
							<span class="mpcth-currency"></span>
						</div>
							<ul id="mpcth_header_socials" class="mpcth-socials-list">
								<li><a target="_blank" href="" class="mpcth-social-facebook"><i class="fa fa-facebook"></i></a></li>
								<li><a target="_blank" href="" class="mpcth-social-google-plus"><i class="fa fa-google-plus"></i></a></li>
								<li><a target="_blank" href="" class="mpcth-social-linkedin"><i class="fa fa-linkedin"></i></a></li>
								<li><a target="_blank" href="" class="mpcth-social-twitter"><i class="fa fa-twitter"></i></a></li>
							</ul>
						</div>
						</div>
				</div>-->
                 ...
                 <?php get_template_part('templates/mobile_menu_header'); ?>    
                    ...
                    <div class="header_wrapper <?php echo $transparent_class . $is_top_bar_class; ?>">
                        <div class="header_wrapper_inside">
							...
							<main id="main" class="headersearch">
